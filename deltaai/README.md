...
| TruthfulQA, track Q | [`TRUTHFULQA_RUN.md`](TRUTHFULQA_RUN.md) | `run_truthfulqa_prep.slurm` `run_tqa_baseline.slurm` `run_truthfulqa_reach.slurm` `run_truthfulqa_judge.slurm` |
